<template>
  <div id="app">
    ...
    <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row" v-if="$route.path !== '/login' && $route.path !== '/register'">
      <div class="navbar-brand-wrapper d-flex justify-content-center">
        ...
        >
          ...
          /> -->
          <h4 style="color: white;"> Demo</h4></a>
        ...
        <ul class="navbar-nav mr-lg-2">
          <li class="nav-item nav-profile dropdown">
            ...
            >
              ...
              <a class="dropdown-item" href="#" @click="logoutBtn();">
    ...
    <!-- partial -->
    <nav class="navbar-breadcrumb col-xl-12 col-12 d-flex flex-row p-0" v-if="$route.path !== '/login' && $route.path !== '/register'">
      ...
      <NavBarCompany :companyName="companyName"/>
    </nav>
    <div class="container-fluid page-body-wrapper">
      <!-- partial:partials/_settings-panel.html -->
      <div class="theme-setting-wrapper" v-if="$route.path !== '/login'">
      ...
      <div id="right-sidebar" class="settings-panel" v-if="$route.path !== '/login'">
        <i class="settings-close typcn typcn-times"></i>
          ...
          >
            ...
            <div class="events py-4 border-bottom px-3">
              <div class="wrapper d-flex mb-2">
                <i
                  class="typcn typcn-media-record-outline text-primary mr-2"
                ></i>
      ...
      <SideMenu v-if="$route.path !== '/login' && $route.path !== '/register'"/>
      <!-- partial -->
...
export default {
  ...
  methods: {
    async getDefaultData () {
      ...
      //     'http://localhost:8000/api/login/' + companyID
      //   )
